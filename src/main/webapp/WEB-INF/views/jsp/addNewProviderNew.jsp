      ...
      <div class="modal-body">
        <form:form commandName="employeeForm" id="employeeRegistrationForm">
          <div class="control-group" id="positionControlGroup">
            <div class="controls">
              <form:input class="form-control" placeholder="Введите должность" required="required" path="position"/>
              <span class="help-inline"><form:errors path="position" cssClass="error"/></span>
            </div>
          </div>
          <div class="control-group" id="fullNameControlGroup">
            <div class="controls">
              <form:input class="form-control" placeholder="Введите ФИО" required="required" path="fullName"/>
              <span class="help-inline"><form:errors path="fullName" cssClass="error"/></span>
            </div>
          </div>
          <div class="control-group" id="emailControlGroup">
            <div class="controls">
              <form:input class="form-control" placeholder="Введите email" required="required" path="email"/>
              <span class="help-inline"><form:errors path="email" cssClass="error"/></span>
            </div>
          </div>
          <div class="control-group" id="homePhoneNumberControlGroup">
            <div class="controls">
              <form:input class="form-control" placeholder="Введите мобильный телефон" required="required" path="homePhoneNumber"/>
          ...
          <div class="control-group" id="workPhoneNumberControlGroup">
            <div class="controls">
              <form:input class="form-control" placeholder="Введите рабочий телефон" required="required" path="workPhoneNumber"/>
...
<script type="text/javascript">
  ...
  var bindProduct = function (productId) {
    ...
    //вставка строки с новым продуктом
    $selector.before(
        "\<tr id=\"tr" + productId + "\"\>" +
  ...
  function getOtherProducts() {
    $.ajax({
      ...
      success: function (response) {
        ...
        html += '<li class="divider"></li> <li><a data-toggle="modal" data-target="#productRegistrationModal">Добавить новое оборудование</a></li>';
